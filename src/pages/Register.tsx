...
function Register() {
    ...
    // Extraemos la función register del AuthContext en lugar de usar Firebase directamente aquí
    const { register } = useContext(AuthContext);

    const handleRegister = async () => {
        try {
            await register(email, password);
            // Una vez registrado, Firebase inicia la sesión automáticamente y redirigimos a las tareas
            history.push('/tasks');
        } catch (error: any) {
    ...
    return (
        ...
        {/* Botón de retroceso nativo de Ionic para volver al Login */}
